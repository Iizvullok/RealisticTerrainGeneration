...
public class ChunkGeneratorIceIslands implements IChunkGenerator
{
    ...
    public ChunkGeneratorIceIslands(World worldIn, boolean p_i45637_2_, long seed)
    {
        this.world = worldIn;
